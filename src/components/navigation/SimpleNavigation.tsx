...
/**
 * Simple Navigation Component - Test Version
 * 
 * Basic navigation to test if the component renders at all
 */
export default function SimpleNavigation() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-[#F59E0B]/30">
