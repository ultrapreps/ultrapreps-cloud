...
// MVP-Focused Hero Section - Comprehensive Stakeholder Onboarding
function HeroSection() {
  const [activeUserType, setActiveUserType] = useState('student');

  // COMPREHENSIVE: All stakeholder types in the athletics ecosystem
  const userTypes = [
    ...
    { id: 'youthCoach', label: 'Youth Coach', icon: Star, color: 'from-[#F59E0B] to-[#D97706]' },
    { id: 'selectAthlete', label: 'Select Athlete', icon: Award, color: 'from-[#DC2626] to-[#991B1B]' },
    ...
    { id: 'schoolAdmin', label: 'School Admin', icon: Building, color: 'from-[#374151] to-[#1F2937]' },
    { id: 'nilBrand', label: 'NIL Brand', icon: Briefcase, color: 'from-[#7C3AED] to-[#6D28D9]' }
  ];

  // MVP PHASE 1 FOCUS: HeroCard Engine + Mascot Engine + HUD + HYPE Economy
  const userContent = {
    student: {
    ...
    educator: {
      ...
      subtitle: "Monitor student-athlete academic performance",
      features: [
        "📚 Academic Progress Tracking",
        "⚖️ Athletic-Academic Balance Metrics",
        "📋 Eligibility Status Monitoring",
        "👨‍🏫 Teacher-Coach Communication"
      ],
      cta: "Start Educator Portal",
      href: "/teacher-dashboard",
      demo: "/teacher-dashboard"
    },
    recruiter: {
      title: "Talent Discovery Engine", 
      subtitle: "Find and track the next generation of athletes",
      features: [
        "🔍 Advanced Athlete Search & Filters",
    ...
    scout: {
      title: "College Scouting Platform",
      subtitle: "Professional scouting tools for college recruitment",
      features: [
        "👁️ Live Game Film Analysis",
        "📈 Performance Trend Analysis",
        "🏆 Championship & Tournament Tracking",
        "📋 Comprehensive Player Reports"
      ],
      cta: "Access Scout Tools",
      href: "/college-scout-dashboard",
      demo: "/college-scout-dashboard"
    },
    youthCoach: {
      title: "Youth Development Focus",
      subtitle: "Age-appropriate coaching tools and tracking",
      features: [
      ...
      cta: "Coach Youth Athletes",
      href: "/youth-coach-dashboard", 
      demo: "/youth-coach-dashboard"
    },
    selectAthlete: {
      title: "Elite Performance Hub",
      subtitle: "Advanced tools for select-level competition",
      features: [
        "🏆 Elite Performance Analytics",
        "🎯 College Recruitment Portfolio",
        "📊 Advanced HUD & Metrics",
        "⚡ Premium HYPE Economy Access"
      ],
      cta: "Access Elite Tools",
      href: "/stadium/create",
      demo: "/test-hud"
    },
    selectCoach: {
      title: "Elite Coaching Platform",
      subtitle: "Advanced coaching tools for competitive teams",
      features: [
      ...
      cta: "Access Elite Coaching",
      href: "/coach-dashboard",
      demo: "/coach-dashboard"
    },
    campAdmin: {
      title: "Camp Management System",
      subtitle: "Streamline your athletic camp operations",
      features: [
      ...
      cta: "Manage Your Camp",
      href: "/dashboard",
      demo: "/dashboard"
    },
    schoolAdmin: {
      title: "Athletic Department Command",
      subtitle: "Complete oversight of school athletics",
      features: [
        "🏫 Multi-Sport Program Management",
        "💰 Budget & Resource Allocation",
        "📊 Department-Wide Analytics",
        "🏆 Championship & Awards Tracking"
      ],
      cta: "Access Admin Portal",
      href: "/athletic-director-dashboard",
      demo: "/athletic-director-dashboard"
    },
    nilBrand: {
      title: "NIL Partnership Platform",
      subtitle: "Connect with student-athletes for partnerships",
      features: [
        "🤝 Athlete Partnership Discovery",
  ...
  const currentContent = userContent[activeUserType as keyof typeof userContent] || userContent.student;
            ...
            {userTypes.map((type) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={clsx(
                    "px-3 py-4 rounded-lg font-semibold transition-all duration-300 flex flex-col items-center gap-2 text-center min-h-[90px]",
          ...
          >
            ...
            >
              <Link
                ...
                className="ultra-btn-primary px-8 py-4 text-white bg-gradient-to-r from-[#F59E0B] to-[#F97316]"
              >
